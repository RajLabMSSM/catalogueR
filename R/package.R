...
#' \item \href{https://www.ebi.ac.uk/eqtl/}{eQTL Catalogue data portal}
#' }
#'
...
#' \describe{
#' \item{multithread_qtl=TRUE}{Across QTL datasets.}
#' \item{multithread_loci=TRUE}{Across loci.}
#' \item{multithread_tabix=TRUE}{Within tabix files.}
#' }
#'
#' You can also get a speedup by using tabix instead of the rest API
#' Test: For 3 loci, and X QTL datasets:
#' \describe{
#' \item{RESTful API}{7.5 minutes.}
#' \item{Tabix}{27 seconds (*clear winner! ~17x speedup).
