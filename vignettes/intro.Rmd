...
- Because you selected the argument `split_files=T` the query results have been distributed across multiple files and saved to disk (useful when you don't want to load one massive data.table every time you want to looks at specific results subsets).  
